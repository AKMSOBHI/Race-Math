    ...
    <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50">
      ...
      >
        ...
        <div className="grid grid-cols-2 gap-3 mb-4">
          <button 
            className="py-2 px-3 rounded-lg transition text-sm flex items-center justify-center bg-gray-800 text-gray-300 hover:text-white border border-gray-700"
            onClick={() => {
              if (isSoundEnabled) {
                soundService.play('click');
              }
          ...
          <button 
            className="py-2 px-3 rounded-lg transition text-sm flex items-center justify-center"
